...
use crate::{
    branch::integrate_branch_upstream::plan::{
        initial_integration_steps, integration_steps_into_segment_nodes,
    },
    divergence::{
...
use crate::{
    ...
    divergence::resolve_tracking_branch_ref_name,
};
...
pub fn integrate_branch_with_steps<'ws, 'meta, M: RefMetadata>(
    ...
    // We build an editor that also maps the remote referece of the branch we're integrating into.
    ...
    // Segment, from local-ref to merge base with remote-ref.
    // This represents the bounds of the commit chain we're aboutt to manipulate and rebuild.
